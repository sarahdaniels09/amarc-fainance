                    ...
                    <div class="col-md-3">
                        <div class="card shadow border-eee">
                            ...
                            <div class="card-footer bg-white border-top-eee d-flex justify-content-between">
                                    ...
                                    <a  target="_blank" href="{{route('admin.language.edit',$language) }}" class=" btn-sm btn btn-outline-dark" title="@lang('Edit')">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a target="_blank" class="btn btn-sm btn-outline-primary" title="{{trans('Keywords')}}"
